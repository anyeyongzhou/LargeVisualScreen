	...
	>
		<div class="flex flex-col">
			<div class="pl-4 flex items-center flex-1 resize_value_1">
				...
				<span class="ml-2 text-white">未来一周温度</span>
			</div>
		...
		<div ref="demo" class="resize_value_2 pl-4 pr-2"></div>
	</div>
</template>

<script setup lang="ts" name="temperature-of-the-coming-week">
